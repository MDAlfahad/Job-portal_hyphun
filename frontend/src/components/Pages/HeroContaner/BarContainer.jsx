        ...
        <div className="w-full md:h-auto md:px-12 px-4 py-4  md:flex items-center md:gap-20 justify-between text-white">
          <div className=" flex items-center gap-12 justify-between bg-white rounded-full px-6 py-3 text-black md:text-white md:bg-transparent">
            <div className="relative flex  ">
              <img
                className="absolute left-10 w-15 rounded-full h-20 border border-white border-spacing"
                src={Image}
                alt=""
              />
              <img
            ...
            <div>
              ...
              <p className="text-xs md:text-lg">Applicant per day</p>
            </div>
          </div>
          <div className="flex gap-5 items-center bg-white shadow-xl rounded-full px-6 py-3 border my-10 md:my-0 justify-between">
            <div>
              ...
              <p className="text-xs md:text-lg  text-black">Apply Easily</p>
            </div>
            <div>
              <img
                className="h-20 w-20 rounded-full border border-secondary"
                src={Image}
                alt=""
              />
            </div>
