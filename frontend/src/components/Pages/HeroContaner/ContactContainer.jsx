      ...
      <div className="w-full max-w-[1800px] m-auto md:px-12 px-4  py-4 md:py-20 svgbackground noselect">
        <div className="md:flex items-center justify-center md:h-[90vh] lg:h-auto ">
          <div className="md:w-1/2 flex flex-col gap-3">
            ...
            <p className="text-sm md:text-[16px] leading-normal">
              We are Committed to processing the information in order to contact
              you and talk about your Jobs.
            </p>
            <div className="flex flex-col gap-3 pt-20">
                <a className="flex gap-3 text-sm md:text-[16px] items-center max-w-fit" href="mailto:alfahadkhan715@gamil.com">
              <AtSign strokeWidth={1.5} size={22} className="text-secondary "/> alfahadkhan715@gmail.com
            </a>
            <p  className="flex gap-3 text-sm md:text-[16px] items-center" >
          ...
          <div className=" h-full md:w-1/2 mt-10 md:mt-0 ">
            <form action="submit" className="h-full w-full flex flex-col gap-5 items-center justify-center">
              ...
              <button className="w-full px-4 py-2 border rounded-md font-semibold hover:text-white bg-secondary hover:bg-textcolor duration-300">Submit</button>
            </form>
          </div>
        </div>
      </div>
