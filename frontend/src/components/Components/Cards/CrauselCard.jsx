...
const CrauselCard = ()=>{
    return(
        ...
        <div className="md:w-96 px-6 py-6 h-auto flex flex-col gap-2 bg-white border rounded-xl shadow-xl">
            ...
            <div><p className="text-sm md:text-[16px] text-textcolor">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corrupti, vitae molestiae vero magnam, voluptas repellendus in fugiat unde maiores recusandae aliquid hic sed atque magni. Vero rerum iste id officia.</p></div>
